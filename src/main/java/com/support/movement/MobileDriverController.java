...
public class MobileDriverController {
	...
	public Map<String,String> androidList(
		...
		// 예약상태코드가 2 또는 4이고 중복여부를 확인하여 중복 일경우 리턴
		...
		System.out.println(cansleResult.get("phone_num"));
		//--------------------------------------------------------------------
		return cansleResult;
	}
	//===================================================
